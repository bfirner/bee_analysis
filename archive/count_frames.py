...
parallel_command_noBg = [
    ...
    "/research/projects/grail/rmartin/analysis-results/code/bee_analysis6/RemoveBackground.py",
    "--input",
    "{}",
    "--output",
    "{}.avi",
...
parallel_background = [
    ...
    "--results",
    "bgresults.csv",
    "/research/projects/grail/rmartin/bin/RemoveBackground.py",
    "--input",
    "{}",
    "--output",
    "{}.avi",
