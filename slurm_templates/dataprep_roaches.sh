...
succ=$(python3 BIN_PATH/VidActRecDataprep.py --width 300 --height 250 --scale 0.25 --samples 500 --crop_noise 10 --out_channels 1 --frames_per_sample 1 --background_subtraction mog2 "${in_csv}" "${out_tar}")
